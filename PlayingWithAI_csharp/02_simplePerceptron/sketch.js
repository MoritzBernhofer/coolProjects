...
function setup() {
    ...
    bias_1_slider = createSlider(-100, 100);
    bias_2_slider = createSlider(-100, 100);
...
function draw() {
    ...
    bias_1 = bias_1_slider.value() ;
    bias_2 = bias_2_slider.value() ;
...
function decide(point) {
    let result1 = point.x * weight1_1 + point.y * weight1_2 + bias_1;
    let result2 = point.x * weight2_1 + point.y * weight2_2 + bias_2;
